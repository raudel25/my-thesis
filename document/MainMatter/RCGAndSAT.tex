...
\begin{proof}[Demostración del Lema \ref{lem:preda}] \
    ...
    Para demostrar que $W=W'$, se debe demostrar que $W$ es subconjunto de $W'$ y $W'$ es subconjunto de $W$.
