...
\advisor{\\\vspace{0.25cm}MSc. Fernando Raul Rodriguez Flores}
...
\include{MainMatter/RCG}
\include{MainMatter/WordProblemStrategy}
\include{MainMatter/RCGAndSAT}

\backmatter

\include{BackMatter/ConclusionsAndRecomendations}
