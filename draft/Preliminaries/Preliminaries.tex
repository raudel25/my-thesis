...
\comment{\comment{Un homomorfismo es un transductor finito de un solo estado y tantas transiciones hacia el mismo estado como transformaciones de símbolos en el homomorfismo.}{¿esto es vital mencionarlo aquí? Es que me crea más ruido de lo que me aporta, y no es tan sencillo como leerlo y ya.}}{Esto se usa para decir que las RCG no son cerradas bajo transduccion finita
la propiedad del paper solo dice q no son cerradas bajo homomorfismo.}
